...
This command **requires** the project directory as an argument via `/home/ricki/progetti/portfolio/SketchFlow2.0`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/app_spec.txt` and `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/initializer_prompt.md`

If `/home/ricki/progetti/portfolio/SketchFlow2.0` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/app_spec.txt`
...
**Output path:** `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/initializer_prompt.md`
...
**Output path:** `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/`!
>
> **Files created:**
> - `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/app_spec.txt`
> - `/home/ricki/progetti/portfolio/SketchFlow2.0/prompts/initializer_prompt.md`
>
